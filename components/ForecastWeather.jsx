...
export default function ForecastWeather({ meteoData }) {
  ...
  return (
    <div className='relative w-full max-w-3xl rounded-2xl border-2 border-t-[1px] border-b-gray-600/80   border-l-gray-700/50 border-r-gray-400/80 border-t-gray-100/50 text-white'>
      <div className='h-full w-full p-2'>
        <div className='grid-rows-8 grid grid-cols-8 gap-3'>
          <div className='rounded-lg bg-blue-600/50 p-2 shadow-lg portrait:col-span-8 portrait:row-span-2 landscape:col-span-2 landscape:row-span-2'>
            {/* ===================================================================*/}
            ...
            <div className='grid gap-3 portrait:grid-cols-2 portrait:grid-rows-3 landscape:grid-cols-3 landscape:grid-rows-2'>
              {dailyData.slice(1, dailyData.length).map((day, index) => {
                ...
                return (
                  <div
                    key={index}
                    className='rounded-lg bg-gray-500/90 px-2 py-1 shadow-lg'
                  >
                    {/* ===================================================================*/}
